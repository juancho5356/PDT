...
public class DAO_Aficionado {
	...
	private static final String BUSCAR_AFICIONADO= "SELECT * FROM aficionados a INNER JOIN usuarios u ON a.id_usuario = u.id_usuario WHERE u.usuario= ? AND u.\"CONTRASEÑA\"= ?";
